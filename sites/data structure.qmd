...
The full DD2 research data is based on data collected/linked from multiple sources. The following sites include a detailed description of each of the data sources, whereas this site is intended to give an overview of the data structure, the data sources and the definitions of data types.
