...
We have been told (mail from JSN 31.05.2018) not to use the c-peptide measurements from this file (old analysis kit)
...
-   `DataTilDD2medFastende.txt`: We have probably received the file in September 2015 (Anne Gedebjerg). It includes n=5.996 CPR numbers with character results on GAD, glucose, and cpeptid, along with a variable about faste. The majority of the individuals in the file are enrolled before 2015, but it only includes around 80-85% of the individuals enrolled before 2016. There are no dates in the data. The data set includes the variables:
