...
{{< downloadthis ../../files/variable_documentation/biobank.xlsx dname="iobank" icon="file-earmark-text" label="Variable documentation" type="button" class="btn btn-light">}}
