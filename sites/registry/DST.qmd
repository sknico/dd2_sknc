...
| General update (DDV) | Population update, updated biobank data (variables from April 2022), including the new data source FODSTATUS, and a general update of registry data. IL6_TNF was updated with all 22 "pladebiomarkører" and renamed to BIOMARK. The data set GENETIK was also included. The data set INFODATA including e.g., DICTA was also included. | November 2024 | DD2CORE, BIOBANK, DDDA, FOEDSELSDATA, IDNC, FODSTATUS, BIOMARK, GENETIK, INFODATA. |
