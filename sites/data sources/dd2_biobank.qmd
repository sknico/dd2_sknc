...
The majority of the initial 1.053 individuals are also included in this data file. We have been told to use the c-peptide measurements in this data file but to keep the CRP measurements from the original file and this file separated. The unit for CPR is mg/L in both data files.
