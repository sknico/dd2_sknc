...
dname="DD2_questionnaire" icon="file-earmark-text" label="Variable documentation" type="button" class="btn btn-light"\>}}
<!-- Linket skal ændres til excel-filen til seedcase -->
