...
In addition, we are considering making agreements with the Dansk Diabetes Database (DDiD) and Dansk kvalitetsdatabase for diabetisk retinopati (DiaBase), but it depends on funding and data availability. 
